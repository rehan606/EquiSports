      ...
      <div className="w-11/12 mx-auto flex flex-col md:flex-row justify-center items-center min-h-screen  p-4">
        <div className="w-full md:w-6/12">
          ...
          >
            ...
            <button
              type="submit"
              className="w-full bg-[#0A14F5] text-white hover:bg-[#000a50]  py-2 px-4 rounded-md text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500"
            >
              Create an account
            </button>
