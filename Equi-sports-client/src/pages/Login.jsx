...
const Login = () => {
    ...
    return (
        <div>
            ...
            <div className="container mx-auto flex flex-col md:flex-row items-center justify-center min-h-screen pt-5 lg:pt-0">
                <div className="w-full md:w-6/12 bg-white p-8 rounded-md shadow-md   border">
