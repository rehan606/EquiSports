...
const Details = () => {
    ...
    return (
        <div className=''>
            ...
            <div className="w-11/12 lg:w-7/12 mx-auto mt-8 p-6 border  bg-white shadow-md rounded-lg">
                <button
                ...
                <div className="flex flex-col md:flex-row items-center gap-6">
                    <img
                        src={equipment.image}
                        alt={equipment.title}
                        className="w-full h-full md:w-48 md:h-48 object-cover rounded-md"
                    />
                    <div>
                        ...
                        <p className="text-sm text-gray-500"><span className='font-bold text-gray-600'>Customization:</span> {equipment.customization}</p>
